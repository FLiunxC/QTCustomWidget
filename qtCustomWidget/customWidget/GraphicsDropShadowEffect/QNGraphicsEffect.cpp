...
QNGraphicsEffect::QNGraphicsEffect(QObject *parent) : QGraphicsEffect(parent),
    _distance(4.0f),
    _blurRadius(10.0f),
     _color(0, 0, 0, 80)
{
...
void QNGraphicsEffect::draw(QPainter *painter)
{
...
QRectF QNGraphicsEffect::boundingRectFor(const QRectF &rect) const
{
